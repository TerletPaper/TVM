...
namespace VoreMod.Items
{
    public abstract class AmuletBase : ModItem
    {
        ...
        public virtual int EscapeBonus => (int)Tier>4?(int)Tier/2-2:0;
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
			...
			if (this.EscapeBonus>0&&!tooltips.Any((t)=>t.Name == "Escape Limit Bonus"))
			{
				tooltips.Insert(tooltips.FindIndex((t)=>t.Name == "ItemName") + 1, new TooltipLine(base.mod, "Escape Limit Bonus", "+" + this.EscapeBonus + " escape limit"));
			}
        }
